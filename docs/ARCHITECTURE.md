...
## Продуктовые принципы routing

- Для явных и критичных сценариев предпочитать deterministic-логику.
- Для неявных формулировок и разговорных запросов использовать гибридный подход с LLM-assisted routing.
- Не отдавать целиком управление модели там, где простое правило надёжнее, прозрачнее и предсказуемее.
